...
public class CropImgUtil {
    ...
    public static void openCamera(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            imageUri = FileProvider.getUriForFile(activity, "com.dongdutec.ddmnc.fileProvider", outputImage);
        }
        // 启动相机程序
    ...
    public static void startUCrop(Activity activity, Uri sourceUir, float aspectRatioX, float aspectRatioY) {
        ...
        //设置toolbar颜色
        options.setToolbarColor(ActivityCompat.getColor(activity, R.color.cropbar));
        //设置状态栏颜色
        options.setStatusBarColor(ActivityCompat.getColor(activity, R.color.cropstatus));
        //是否隐藏底部容器，默认显示
